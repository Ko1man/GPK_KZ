...
Route::get('/groups/create', [\App\Http\Controllers\GroupsController::class, 'index'])->name('groups.create');
Route::get('/groups', [\App\Http\Controllers\GroupsController::class, 'getGroups'])->name('getGroups');
